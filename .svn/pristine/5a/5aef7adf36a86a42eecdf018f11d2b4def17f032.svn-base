...
<script type="text/javascript">
	...
	function fn_save() {
		...
		callAjax("/mngNot/noticesave.do", "post", "json", false, $("#nofilepopup").serialize() , savecollback) ;
   ...
   function popupinitfile(object) {
	...
	function fn_savefile() {
		...
		var frm = document.getElementById("filepopup");
...
<form id="myForm" action=""  method="">
				...
				<li class="contents">
					...
					<div class="content">
						...
						<div style="display:flex; justify-content:center; align-content:center; border:solid 3px #c0c0c0; border-radius: 10px; padding:40px 40px; margin:20px auto;">
							...
							<div>&nbsp;&nbsp;&nbsp;&nbsp;</div>
							<input type="text" style="width: 300px; height: 28px;" id="sname" name="sname">
  ...
  <form id="filepopup">  
	...
	<input type="hidden" id="file_notice_no"  name="file_notice_no"  />
	<div id="layer2" class="layerPop layerType2" style="width: 600px;">
		<dl>
			<dt>
				<strong>파일 게시글 작성</strong>
			</dt>
			<dd class="content">
