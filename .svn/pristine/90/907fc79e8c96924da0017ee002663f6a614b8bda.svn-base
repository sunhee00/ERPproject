  ...
  <script type="text/javascript">
    ...
    function fn_emplist(pagenum) {
      ...
      var listcollabck = function(returnvalue) {
        ...
        //현재 페이지번호, 총 목록개수, 한 화면에 보일 목록 개수, 페이지네이션 개수, 인사관리 목록조회 -> 페이지네이션
    ...
    /** 인사 상세정보 조회 (사번 통해 정보 조회 후 모달 띄워 정보 조회) */
      ...
      <dd class="content">
        ...
        <table class="row">
          ...
          <tr>
            <th scope="row">사번 </th>
            <td colspan="3">
            	<input type="text" class="inputTxt p100" name="loginID" id="loginID" placeholder="인사 등록 후 확인 가능합니다." style="text-align: center;"/>
            </td>
          </tr>
          ...
          <th scope="row">생년월일 <span class="font_red">*</span></th>
          	<td>
          		<input type="text" class="inputTxt p100" name="emp_birth" id="emp_birth" placeholder="0000-00-00"  style="text-align: center;"/>
          	</td>
          ...
          <tr>
            ...
            <td>
            	<input type="text" class="inputTxt p100" name="name" id="name" style="text-align: center;"/>
            </td>          
            <th scope="row">성별 <span class="font_red">*</span></th>
            <td colspan="3">
            	<input style="margin-left: 15px; margin-right: 10px;" type="radio" name="emp_sex" id="sex_M" value="1"/>남자 
            	<input style="margin-left: 10px; margin-right: 10px;" type="radio" name="emp_sex" id="sex_W" value="2"/>여자 
            </td>            
          </tr>
          <tr>
