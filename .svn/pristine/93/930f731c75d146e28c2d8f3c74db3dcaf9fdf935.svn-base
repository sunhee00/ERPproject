				...
				<table class="row">
					...
					<tbody>
						<tr style="height: 80px;">
							...
							<td colspan="2">
								<input type="text" class="inputTxt p100" style="" name="acnt_sbject_cd" id="acnt_sbject_cd"  placeholder="숫자 4자리를 입력해주세요.(ex.1111)"  />
						...
						<tr>
							...
							<td colspan="2"><input type="text" class="inputTxt p100"  name="acnt_sbject_name" id="acnt_sbject_name" placeholder="한글로 입력해주세요.(ex. 매출)" /></td>
						</tr>
						<tr>
				...
				<table class="row">
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3"><input type="text" class="inputTxt p100" name="acnt_dt_sbjct_name" id="acnt_dt_sbjct_name" placeholder="한글로 입력해주세요.(ex. 제품매출)"/></td>
						</tr>
